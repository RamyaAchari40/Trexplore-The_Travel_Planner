...
<head>
   ...
   <style>
      ...
      body {
    background-image: url("https://wallpaperbat.com/img/24963-travelling-wallpaper.jpg");
...
.form-container{
   ...
   background: linear-gradient(to top, #0c0c0e, #293039bb), url(https://images.unsplash.com/photo-1709594625825-7c03659c695d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzfHx8ZW58MHx8fHx8);
}
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      ?>
      <input type="text" name="name" placeholder="enter username" class="form-control box" required>
      ...
      <input type="password" name="cpassword" placeholder="confirm password" class="form-control box" required>
